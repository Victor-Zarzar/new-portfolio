        ...
        <main className="courses">
            <section className="col-span-4 mx-auto">
                <header className="h1 p-6">
                    <Fade>
                        <h1 className="title-projects mb-4 font-extrabold leading-10 tracking-tight text-3xl md:text-4xl text-center">{t('h1')}</h1>
                    </Fade>
                </header>
            </section>
            ...
            <section className="p-4 flex flex-col gap-4 items-center mb-20 md:mb-32">
                ...
                >
                    ...
                    <div className="px-4 py-3 text-sm md:text-base">
                        <span className="text-neutral-800 dark:text-neutral-200 font-bold">victorzarzar</span>
                        <span className="text-green-700 dark:text-green-500">@archlinux</span>
                        <span className="text-neutral-600 dark:text-neutral-400"> in </span>
                        <span className="text-blue-500 dark:text-blue-400">~</span>
                        <span className="text-yellow-600 dark:text-yellow-400"> v3.10.4</span>
                    ...
                    <div className="px-4 text-sm md:text-base text-neutral-800 dark:text-neutral-200">
                        $ <span className="text-neutral-800 dark:text-neutral-200">{t('p')}</span>
                    </div>
                    ...
                    <div className="px-4 py-3">
                        <ul className="space-y-1 text-xs md:text-base">
                            {courses.map((course, index) => (
                                <li key={index}>
                                    <Link href={course.url} target="_blank" className="hover:underline transition-colors">
