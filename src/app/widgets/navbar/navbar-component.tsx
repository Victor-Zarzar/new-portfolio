...
export default function Navbar() {
  ...
  return (
    <nav className="dark:bg-stone-950 bg-[#ffffff] w-full mx-auto px-4 md:px-5 lg:px-20 fixed top-0 z-50 shadow dark:border-b dark:border-stone-600 border-gray-300">
