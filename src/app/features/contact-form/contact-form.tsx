    ...
    return (
        ...
        >
            <CardHeader className="pb-4">
                ...
                <CardDescription className="text-sm md:text-base">{t('cardSubtitle')}</CardDescription>
            </CardHeader>

            <CardContent className="space-y-6">
                <div className="flex items-center gap-4">
                    <span className="text-xs md:text-sm text-muted-foreground">{t('socialText')}</span>
