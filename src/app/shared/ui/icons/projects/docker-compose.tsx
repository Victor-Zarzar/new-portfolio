        ...
        >
            <g>
                <g transform="translate(20, 30)">
                    ...
                    <path d="M56,36 C56,42 60,48 66,48 C72,48 76,42 76,36 C76,30 72,24 66,24 C60,24 56,30 56,36 Z" fill="#0DB7ED" />
                    <path d="M0,48 L82,48 C84,54 78,60 72,60 L10,60 C4,60 -2,54 0,48 Z" fill="#0DB7ED" />
                </g>
                ...
                <g transform="translate(110, 80)">
                    ...
                    <path d="M56,36 C56,42 60,48 66,48 C72,48 76,42 76,36 C76,30 72,24 66,24 C60,24 56,30 56,36 Z" fill="#2496ED" />
                    <path d="M0,48 L82,48 C84,54 78,60 72,60 L10,60 C4,60 -2,54 0,48 Z" fill="#2496ED" />
                </g>
                ...
                <text x="200" y="56" textAnchor="middle" fill="#FFFFFF" fontSize="14" fontWeight="bold">
                    DC
                </text>
            </g>
        </svg>
