...
const DartIcon: React.FC<SvgIconProps> = ({ size = 26, ...props }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 128 128" className="hover:-translate-y-1" {...props}>
            ...
            <path fill="#22d3c5" d="M27.7 93.4zm81.9 15.9l-16.3 7.2l-65.4-23.1c1.3 4.8 4 10.1 7 13.2l21.3 21.2l47.6.1l5.8-18.6z" />
            <path
                fill="#0075c9"
            ...
            />
            <path fill="#00a8e1" d="M93.6 27.3c.2 0 .2 0 0 0c.2 0 .2 0 0 0zm16 82l17.7-5.8V54.8l-20.4-20.5c-3-3-8.3-5.8-13.2-7l23.1 65.6" />
