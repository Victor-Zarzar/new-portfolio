    ...
    return (
        ...
        >
            <g>
                ...
                <path d="M128 145 Q123 150 118 148 Q128 155 138 148 Q133 150 128 145" fill="#000000" />
                ...
                <text x="128" y="75" textAnchor="middle" fill="#FFFFFF" fontSize="18" fontWeight="bold">
                    pd
                </text>
            </g>
        </svg>
